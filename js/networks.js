...
(function () {
  angular.module('app').controller('NetworksCtrl', function ($scope, api, $mdDialog, $mdMedia, $routeParams, $location, $timeout) {
    ...
    $scope.saveNetwork = function () {
      ...
      success(api.addNetwork).
      error(function (e) {
        api.toast("Couldn't Save Network - " + e.message, 'networks', e);
      });
    ...
    $scope.saveNetworkRanges = function () {
      ...
      Object.keys(data).forEach(function (id) {
        ...
        error(function (e) {
          api.toast("Couldn't Save Network Range - " + e.message, 'network_ranges', e);
        });
    ...
    $scope.addRange = function () {
      ...
      error(function (e) {
        api.toast("Couldn't Add Network Range - " + e.message, 'network_ranges', e);
      });
    };
    ...
    $scope.saveNetworkRouter = function () {
      ...
      error(function (e) {
        api.toast("Couldn't Save Network Router - " + e.message, 'network_routers', e);
      });
